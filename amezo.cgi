...
@a = ($comm =~ /<br>/g);
(@a + 0 > 20 || $comm =~ /￣￣/) && &error("Your comment is too long.");
$name =~ s/ |　//g;
$x = $subj.$name.$comm;
...
$line = <<EOL;
$subj1<dl><dt>$cnt$subj2 Poster：<font color=forestgreen><b>$name </b></font>
<font size=-1>　Posted：$date</font><br><dd>$comm </dl>
EOL
$line =~ s/\n//g;
print W "$line\n";
$line = <<EOL;
...
<input type=submit value="↑ Response" ><br>
...
$sub<a href="#top">Up.　</a><a href="./">Reset</a><br>
<textarea name="comm" rows=4 cols=70 ></textarea>
</form><hr>
</td></tr></table>
EOL
